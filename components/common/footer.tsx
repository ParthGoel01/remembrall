      ...
      <footer className="bg-gray-200 text-gray-700 py-6">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-4">
          <div className="text-center md:text-left mb-4 md:mb-0">
            <h1 className="text-xl font-bold">Remembrall</h1>
            <p className="text-sm mt-1">© 2025 All Rights Reserved</p>
          </div>
  
          <div className="flex flex-wrap justify-center md:justify-end space-x-4">
            <a href="/privacy" className="text-gray-700 hover:text-black hover:underline transition duration-300 text-sm">Privacy Policy</a>
            <a href="/terms" className="text-gray-700 hover:text-black hover:underline transition duration-300 text-sm">Terms of Service</a>
            <a href="/contact-us" className="text-gray-700 hover:text-black hover:underline transition duration-300 text-sm">Contact Us</a>
          </div>

          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://github.com/ParthGoel01/remembrall" target="_blank">
